...
class OnboardingScreen10View extends StatelessWidget {
  const OnboardingScreen10View({super.key});
            ...
            child: Stack(
              children: [
                Positioned(
                  ...
                  left: 167.w,
                  child: Image.asset(
                    'assets/onboarding_screens/onboarding_screen_10/Frame 51260.png',
                  ),
                ),
                Positioned(
                    top: 63.h,
                      ...
                      RichText(
                        text: TextSpan(
                            ...
                            children: const [
                              ...
                              TextSpan(
                                text: " your live classes with teachers",
                              )
                            ]),
                      ),
                      8.verticalSpace,
                ...
                Positioned(
                  ...
                  child: TextButton(
                      onPressed: () {
                        Navigator.pushNamed(context, '/onboarding_screen_11');
                      },

...
class OnboardingScreen11View extends StatelessWidget {
  const OnboardingScreen11View({super.key});
            ...
            child: Stack(
              children: [
                Positioned(
                  ...
                  left: 167.w,
                  child: Image.asset(
                    'assets/onboarding_screens/onboarding_screen_11/Frame 51260.png',
                  ),
                ),
                Positioned(
                    top: 63.h,
                ...
                Positioned(
                  ...
                  child: TextButton(
                      onPressed: () {
                        Navigator.pushNamed(context, '/login_screen_3');
                      },
